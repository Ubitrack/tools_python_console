...
import enaml
with enaml.imports():
    from .views.absolute_orientation_triggered_calibration import AbsoluteOrientationTriggeredCalibrationPanel
...
class AbsoluteOrientationTriggeredCalibrationController(LiveCalibrationController):
    ...
    def setupController(self, active_widgets=None):
        super(AbsoluteOrientationTriggeredCalibrationController, self).setupController(active_widgets=active_widgets)
...
class AbsoluteOrientationTriggeredCalibrationModule(ModuleBase):

    def get_category(self):
        return "Co-location"

    def get_widget_class(self):
        return AbsoluteOrientationTriggeredCalibrationPanel

    def get_controller_class(self):
        return AbsoluteOrientationTriggeredCalibrationController