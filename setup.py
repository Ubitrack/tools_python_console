...
This module controls my garden""",
      classifiers = [
        ...
        entry_points={
            ...
            # ],
            'vharcalibration.plugin.modules': [
                ...
                'camera_intrinsics_new = utinteractiveconsole.plugins.calibration.modules.camera_intrinsics_new:CameraIntrinsicsCalibrationNewModule',
                ...
                'absolute_orientation_triggered_calibration = utinteractiveconsole.plugins.calibration.modules.absolute_orientation_triggered_calibration:AbsoluteOrientationTriggeredCalibrationModule',
