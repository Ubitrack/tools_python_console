      ...
      classifiers = [
        ...
        entry_points={
            ...
            'vharcalibration.plugin.modules': [
                ...
                'absolute_orientation_triggered_calibration = utinteractiveconsole.plugins.calibration.modules.absolute_orientation_calibration_triggered:AbsoluteOrientationTriggeredCalibrationModule',
